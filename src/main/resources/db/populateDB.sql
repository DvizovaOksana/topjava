...
INSERT INTO meals(user_id, datetime, description, calories) VALUES
    ...
    (100000, '2020-01-31 10:00:00', 'Еда на граничное значение', 100),
    (100000, '2020-01-31 10:00:00', 'Завтрак', 1000),
    (100000, '2020-01-31 10:00:00', 'Обед', 500),
    (100000, '2020-01-31 10:00:00', 'Ужин', 410),
    (100001, '2020-05-09 14:00:00', 'Админ ланч', 510),
    (100001, '2020-05-09 21:00:00', 'Админ ужин', 1500);
